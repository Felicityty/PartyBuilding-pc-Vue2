<template>
  <div>
    ...
    >
      ...
      <el-form ref="addFormRef" :model="addForm" :rules="rules" label-width="25%">
        <el-form-item label="姓名:" prop="userName">
          <el-input v-model="addForm.userName" placeholder="请输入" style="width: 60%" />
        </el-form-item>
        <el-form-item label="学号:" prop="stuNo">
          <el-input v-model="addForm.stuNo" placeholder="请输入" style="width: 60%" />
        </el-form-item>
        <el-form-item label="支部名称:" prop="partyBranchName">
          <el-select v-model="addForm.partyBranchName" placeholder="请选择" style="width: 60%" @change="currStationChangeAdd">
        ...
        <el-form-item label="班级名称:" prop="classGradeName">
          <el-select v-model="addForm.classGradeName" placeholder="请选择" style="width: 60%">
        ...
        <el-form-item label="内容:" prop="contentList">
          <div v-for="(item,index) in addForm.contentList" :key="index">
            <el-input v-model="item.contentItem" placeholder="请输入" type="text" style="width: 60%" />
        ...
        <el-form-item label="总分:" prop="score">
          <el-input v-model="addForm.score" style="width: 60%" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="附件:" prop="fileName">
          <!-- <el-input v-model="addForm.fileName" placeholder="请输入" style="width: 60%" /> -->
