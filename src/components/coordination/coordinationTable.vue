<template>
  <div>
    <!-- 组织协调列表区域 -->
    <el-table ref="table" v-loading="tableListLoading" :data="coordinationList" stripe style="width: 100%" fit :row-key="(record) => record.developAbilityId" @selection-change="handleSelectionChange">
