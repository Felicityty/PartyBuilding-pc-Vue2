  ...
  <el-dialog title="编辑" :visible.sync="dialogVisible" width="35%" @close="handleClose()">
    ...
    <el-form ref="EditFormRef" :model="form" :rules="editRules" label-position="right" label-width="35%">
      ...
      <el-form-item label="文件名:" prop="fileName">
        <el-input v-model="form.fileName" style="width: 70%" />
      </el-form-item>
      <!-- <el-form-item label="附件" prop="file">
        <el-upload class="upload-demo" action="https://jsonplaceholder.typicode.com/posts/" multiple :limit="3" :file-list="editList.files" style="width: 80%">
